          ...
          <Container className="pricing__container">
            ...
            <Row className="pricing__row--content">
              ...
              >
                ...
                {/* <hr></hr> */}
                <div className="pricing__column--services--item">Interior</div>
                <div className="pricing__column--services--item">Aerial</div>
                <div className="pricing__column--services--item">Panorama</div>
              </Col>
              <Col
                xs={6}
                sm={6}
              ...
              >
                <div className="pricing__column--content--heading">Content</div>
                {/* <hr></hr> */}
                ...
                <div className="pricing__column--content--item">1 Panorama</div>
              </Col>
              <Col
                xs={3}
                sm={3}
          ...
          <Container className="pricing__container">
            ...
            <Row className="pricing__row--content">
              ...
              >
                ...
                <div className="pricing__column--services--item">Business</div>
